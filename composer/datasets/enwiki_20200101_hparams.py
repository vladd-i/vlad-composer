...
"""Wikipedia 2020-01-01 dataset hyperparameters."""
import logging
...
from composer.datasets.enwiki_20200101 import StreamingWiki
from composer.datasets.dataset_hparams import DataLoaderHparams, DatasetHparams
from composer.utils.import_helpers import MissingConditionalImportError

log = logging.getLogger(__name__)

__all__ = ['StreamingWikiHparams']


@dataclass
class StreamingWikiHparams(DatasetHparams):
    """Builds a :class:`.DataSpec` for the StreamingWiki (Wikipedia 2020-01-01) dataset.
